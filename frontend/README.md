...
1. **Clone the repository**
   ...
   ```bash
   git clone https://github.com/nickheyer/ProxmoxVE.git
...
- **[Community Scripts Repository](https://github.com/nickheyer/ProxmoxVE)**
- **[Discord Community](https://discord.gg/3AnUqsXnmK)**
- **[GitHub Discussions](https://github.com/nickheyer/ProxmoxVE/discussions)**
...
- **📝 Change Log**: [https://github.com/nickheyer/ProxmoxVE/blob/main/CHANGELOG.md](https://github.com/nickheyer/ProxmoxVE/blob/main/CHANGELOG.md)
