...
```bash
# 1. Fork on GitHub
# Visit: https://github.com/nickheyer/ProxmoxVE → Fork (top right)
...
bash -c "$(curl -fsSL https://raw.githubusercontent.com/nickheyer/ProxmoxVE/main/ct/myapp.sh)"
...
git remote add upstream https://github.com/nickheyer/ProxmoxVE.git
...
- **GitHub**: [community-scripts/ProxmoxVE](https://github.com/nickheyer/ProxmoxVE)
- **Issues**: [GitHub Issues](https://github.com/nickheyer/ProxmoxVE/issues)
- **Discussions**: [GitHub Discussions](https://github.com/nickheyer/ProxmoxVE/discussions)
