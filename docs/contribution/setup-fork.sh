...
# upstream   https://github.com/nickheyer/ProxmoxVE.git (fetch)
# upstream   https://github.com/nickheyer/ProxmoxVE.git (push)
```
...
print_info "Upstream: https://github.com/nickheyer/ProxmoxVE"
echo ""
